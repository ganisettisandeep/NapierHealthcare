...
public class TC_QualityDashboardAllDetails extends BaseClass {
	@Test
	public void TC_QualityDashboardAllDetails() throws IOException, InterruptedException{
		...
		capureScreen(driver,"TC_QualityDashboardAllDetails");
