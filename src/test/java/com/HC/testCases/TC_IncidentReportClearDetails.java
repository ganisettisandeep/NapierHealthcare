...
public class TC_IncidentReportClearDetails extends BaseClass {
	@Test
	public void TC_IncidentReportClearDetails() throws IOException, InterruptedException, AWTException{
		...
		*/		
		...
		capureScreen(driver,"TC_IncidentReportClearDetails");
		
		//verify clear
		String result = in.verifyClearIR();
		Assert.assertEquals(result, "");
		logger.info("verify clear");
		Thread.sleep(2000);
