...
public class TC_IncidentDashboardSentinelEvents extends BaseClass {
	@Test
	public void TC_IncidentDashboardSentinelEvents() throws IOException, InterruptedException{
		...
		//sentinelEvents link
		db.sentinelEvents();
		logger.info("sentinelEvents is clicked");
		Thread.sleep(2500);

		capureScreen(driver,"TC_IncidentDashboardSentinelEvents");
